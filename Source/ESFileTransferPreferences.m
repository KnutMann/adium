...
- (void)viewDidLoad
{
	...
	[checkBox_autoAcceptFiles setTitle:[AILocalizedString(@"Automatically accept files and images","File Transfer preferences") stringByAppendingEllipsis]];
	[checkBox_autoAcceptOnlyFromCLList setTitle:AILocalizedString(@"only from contacts on my Contact List","File Transfer preferences")];
	[checkBox_autoOpenFiles setTitle:AILocalizedString(@"Open \"Safe\" files after receiving","File Transfer preferences")];
	[checkBox_showProgress setTitle:AILocalizedString(@"Show the File Transfers window automatically","File Transfer preferences")];
