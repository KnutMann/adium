...
- (void)windowDidLoad
{
	...
	[button_chooseIcon setTitle:[AILocalizedString(@"Choose Icon",nil) stringByAppendingEllipsis]];
	[button_OK setTitle:AILocalizedString(@"OK",nil)];
	[button_cancel setTitle:AILocalizedString(@"Cancel",nil)];
	[checkbox_autoconnect setTitle:AILocalizedString(@"Connect when Adium opens", "Account preferences checkbox for automatically conencting the account when Adium opens")];
