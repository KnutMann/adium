...
- (void)windowDidLoad
{
	...
	[searchField setCell:[NSKeyedUnarchiver objectWithArchivedData:[NSKeyedArchiver archivedDataWithObject:[searchField cell]]]];	
...
- (void)windowWillClose:(NSNotification *)notification
{
	...
	[slideWindowIfNeededTimer invalidate]; slideWindowIfNeededTimer = nil;
...
- (void)close:(id)sender
{
    ...
    CFTypeRef keptAlive = CFBridgingRetain(self);
