 ...
 * a nib for us. AIURLHandlerPreferences.xib is dead — and it must stay unloaded:
 * it still wires an outlet this class no longer has (tableView) and hangs the
 * table's dataSource and delegate off us, so loading it would raise
