...
/* Generic dotted-version comparison, required by AIAdiumProtocol
 * (used by the plugin loader); originally from SUStandardVersionComparator. */

typedef enum {
    kNumberType,
    kStringType,
    kPeriodType
} AIVersionCharacterType;

- (AIVersionCharacterType)typeOfCharacter:(NSString *)character
{
...
- (NSComparisonResult)compareVersion:(NSString *)appVersion toVersion:(NSString *)appcastVersion;
{
    ...
    if ([partsA count] != [partsB count]) {
        ...
        AIVersionCharacterType missingType;
