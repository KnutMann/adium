...
/*!
 * @brief The ⊖ of a row was clicked, or "Move to Trash" was chosen from its context menu
 */
 ...
 * name, a line of detail, a switch which enables or disables it and a ⊖ which throws it away.
 *
