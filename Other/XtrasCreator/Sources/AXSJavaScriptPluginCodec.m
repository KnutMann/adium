...
+ (NSString *)scaffoldSource
{
	...
	@"//\n"
	@"// A setting your Info.plist declares under AIJavaScriptPluginSettings arrives\n"
	@"// as a string on adiumPlugin.settings, and Adium draws a menu for it on your\n"
	@"// extension's own page. Read it with a fallback of your own, so the plugin\n"
	@"// still runs where the setting does not reach it:\n"
	@"//\n"
