...
#
# Three things are not checked in, for three different reasons, and a fresh clone cannot be
# built without all three. Until this script existed each of them was somebody's job to
