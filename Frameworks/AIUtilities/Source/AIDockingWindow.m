...
/* The contact list does have a toolbar; it is built in code rather than in the nib, which
 * is why the window there looks as though it had none. Whoever watches for it appearing
 * and disappearing has to be told by this window as much as by the other one. */
- (void)toggleToolbarShown:(id)sender
{
	[super toggleToolbarShown:sender];
